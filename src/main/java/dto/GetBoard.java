...
public class GetBoard {
    ...
    public String toString() {
        ...
        sb.append(GetBoard.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
          .append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GetBoard) == false) {
            return false;
        }
        GetBoard rhs = ((GetBoard) other);
        return (((((((((((((this.descData == rhs.descData) ||
            ...
            ((this.shortUrl == rhs.shortUrl) ||
                ((this.shortUrl != null) && this.shortUrl.equals(rhs.shortUrl)))) &&

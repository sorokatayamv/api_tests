...
public class Labels__2 {
    ...
    public String toString() {
        ...
        sb.append(Labels__2.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
          .append('[');
        sb.append("green");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Labels__2) == false) {
            return false;
        }
        Labels__2 rhs = ((Labels__2) other);

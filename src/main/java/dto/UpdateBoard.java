...
public class UpdateBoard {
    ...
    public Labels__2 getLabels() {
        return labels;
    }

    public void setLabels(Labels__2 labels) {
        this.labels = labels;
    }
    ...
    public String toString() {
        ...
        sb.append(UpdateBoard.class.getName()).append('@')
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof UpdateBoard) == false) {
            return false;
        }
        UpdateBoard rhs = ((UpdateBoard) other);
        return (((((((((((((this.descData == rhs.descData) || ((this.descData != null) &&
            this.descData.equals(rhs.descData))) &&
            ((this.pinned == rhs.pinned) ||
                ((this.pinned != null) && this.pinned.equals(rhs.pinned)))) &&
            ((this.labels == rhs.labels) || ((this.labels != null) &&
            ...
            ((this.prefs == rhs.prefs) || ((this.prefs != null) && this.prefs.equals(rhs.prefs)))) &&
            ((this.idEnterprise == rhs.idEnterprise) ||
                ((this.idEnterprise != null) && this.idEnterprise.equals(rhs.idEnterprise)))) &&
            ((this.name == rhs.name) || ((this.name != null) && this.name.equals(rhs.name)))) &&
            ((this.idOrganization == rhs.idOrganization) ||
                ((this.idOrganization != null) && this.idOrganization.equals(rhs.idOrganization)))) &&
